...
function AdminDashboard() {
  ...
  const [siteSettingsData, setSiteSettingsData] = useState({
    ...
    copyrightText: '© 2006-{year} TraveloFare. All rights reserved.',
  ...
  useEffect(() => {
    const fetchSeoToolData = async () => {
      ...
      if (activeSeoTool === 'backlinks' && seoToolData.backlinks.total === 0) {
        try {
          const response = await fetch(`${API_URL}/api/seo/backlinks?domain=travelofare.com`, {
            headers: { 'Authorization': `Bearer ${token}` }
          });
          if (response.ok) {
            const data = await response.json();
  ...
  const handleGenerateSingleBlog = async () => {
    ...
    try {
      ...
      if (data.success) {
        const blogUrl = data.url || `https://travelofare.com/blog/${data.post.slug}`;
    ...
    try {
      ...
      if (data.success) {
        const blogUrls = data.posts ? data.posts.map(post => 
          `https://travelofare.com/blog/${post.slug}`
        ).join('\n') : '';
                    ...
                    <div className="connect-card">
                      ...
                      <form className="gsc-settings-form" onSubmit={async (e) => {
                        ...
                        <div className="form-group">
                          ...
                          <input
                            type="url"
                            name="siteUrl"
                            placeholder="https://travelofare.com"
                            defaultValue="https://travelofare.com"
                            required
                          />
                        </div>
                      ...
                      <div className="gsc-help-text">
                        ...
                        <ol>
                          ...
                          <li>Add redirect URI: <code>https://travelofare.com/api/gsc/oauth2callback</code></li>
            ...
            <form onSubmit={handleSEOUpdate} className="seo-form">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="https://travelofare.com/og-image.jpg"
                />
              </div>
            ...
            <form onSubmit={handleContentUpdate} className="content-form">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="support@travelofare.com"
                />
              </div>
                        ...
                        <div className="post-details">
                          ...
                          {post.slug && (
                            <div className="blog-url">
                              <a href={`https://travelofare.com/blog/${post.slug}`} target="_blank" rel="noopener noreferrer" className="url-link">
                                📍 travelofare.com/blog/{post.slug}
                              </a>
                              <button 
                                onClick={() => {
                                  const url = `https://travelofare.com/blog/${post.slug}`;
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group full-width">
                    ...
                    <input
                      ...
                      placeholder="© 2006-{year} TraveloFare. All rights reserved."
                    />
              ...
              <div className="settings-card">
                ...
                <div className="color-presets">
                  ...
                  <div className="preset-grid">
                    ...
                    <button type="button" className="preset-btn" onClick={() => setSiteSettingsData({...siteSettingsData, colors: {...(siteSettingsData.colors||{}), headerBg: 'linear-gradient(135deg, #38a169 0%, #276749 100%)', footerBg: 'linear-gradient(135deg, #1a202c 0%, #22543d 100%)', headerText: '#ffffff', footerText: '#c6f6d5'}})}>
                      <span className="preset-swatch" style={{background:'linear-gradient(135deg,#38a169,#276749)'}}></span>
                      Forest Green
                    </button>
