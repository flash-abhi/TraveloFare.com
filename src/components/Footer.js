      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          <div className="footer-column footer-about">
            <Link to="/" className="footer-logo-link" aria-label="TraveloFare home">
              <Logo size="medium" />
            </Link>
        ...
        <div className='container'>
            ...
            <p>travelofare.com is a travel booking service and a part of TraveloFare and not an airline. We act as an intermediary between customers and airlines, facilitating flight reservations. We are not responsible for flight cancellations, delays, or service disruptions caused by airlines. All bookings are subject to airline policies, and any refunds or changes are governed by their terms. Passengers must ensure they have valid travel documents before booking.</p>
        </div>
          ...
          <div className="footer-bottom-content">
            <p className="copyright-legal">
              {siteSettings.copyrightText ||
                `© 2018-${currentYear} TraveloFare. All rights reserved.`}{" "}
