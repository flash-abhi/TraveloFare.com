...
class BlogPublisherService {
  ...
  async publishToMedium(blogPost) {
    ...
    const response = await axios.post(
      `https://api.medium.com/v1/users/${userId}/posts`,
      {
        ...
        canonicalUrl: `https://travelofare.com/blog/${blogPost.slug}`
      },
      {
        headers: {
    ...
    const response = await axios.post(
      'https://dev.to/api/articles',
      {
        article: {
          ...
          canonical_url: `https://travelofare.com/blog/${blogPost.slug}`,
  ...
  convertToMediumFormat(content) {
    ...
    return content + '\n\n---\n\n*Originally published at [travelofare.com](https://travelofare.com)*';
  }
        ...
        platforms: [
          {
            ...
            instructions: 'Copy content and paste. Add canonical URL to travelofare.com',
            canonicalUrl: `https://travelofare.com/blog/${blogPost.slug}`
          },
          {
            name: 'Dev.to',
          ...
          },
          {
            ...
            instructions: 'Write article, paste content, link back to travelofare.com'
          },
          {
            name: 'Hashnode',
            da: 88,
