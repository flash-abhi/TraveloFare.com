      ...
      <div className="container">
        <div className="legal-content">
          <section>
            ...
            <p>By accessing and using travelofare.com, you accept and agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, please do not use our services.</p>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li>Cancellation requests must be submitted in writing to support@travelofare.com</li>
          ...
          <section>
            ...
            <ul>
              ...
              <li>travelofare.com is not responsible for denied boarding due to invalid documents.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <section>
              ...
              <p>All content on travelofare.com, including text, graphics, logos, and software, is our property or licensed to us. You may not reproduce, distribute, or create derivative works without written permission.</p>
            </section>

          <section>
            <h2>8. Price Guarantee</h2>
            <p>We strive to offer the best prices. If you find a lower price within 24 hours of booking, contact us for a potential price match (subject to terms and verification).</p>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li>Email: support@travelofare.com</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>Email: legal@travelofare.com</li>
              <li>Phone: {contactSettings.tfn}</li>
            </ul>
          </section>
        </div>
